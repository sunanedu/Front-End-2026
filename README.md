...
|-------|-----------|--------------|
| 1 | รากฐานและเส้นทางของนักพัฒนา Front-End | 2 สัปดาห์ |
| 2 | HTML, CSS และการออกแบบ UI สมัยใหม่ | 3 สัปดาห์ |
| 3 | JavaScript สมัยใหม่และ TypeScript | 3 สัปดาห์ |
| 4 | React และ Next.js — Framework หลัก | 4 สัปดาห์ |
| 5 | การเชื่อมต่อ API, Authentication และการจัดการข้อมูล | 3 สัปดาห์ |
| 6 | การทดสอบ, การ Deploy และการทำงานในทีมมืออาชีพ | 3 สัปดาห์ |

---

## หน่วยที่ 1: รากฐานและเส้นทางของนักพัฒนา Front-End
