...
---
### ก่อนที่จะทดลง สิ่งที่ต้องติดตั้งก่อนมีดังนี้
#### 1. Node.js
ดาวน์โหลดจาก **<https://nodejs.org>** แนะนำเวอร์ชัน LTS (ปัจจุบัน 22.x)
การติดตั้ง Node.js จะได้ `npm` มาด้วยอัตโนมัติ
ตรวจสอบหลังติดตั้ง:
bash
```bash
node -v
...
#### 2. pnpm
เมื่อมี npm แล้ว ติดตั้ง pnpm ด้วยคำสั่ง:
bash
```bash
npm install -g pnpm
```
